...
inline fun zstream.deflateParams(level: Number, strategy: Number): Number = TODO()
...
inline fun zstream.deflateGetDictionary(dictionary: Uint8Array?): Array<Number> = TODO()
...
inline fun zstream.inflateGetDictionary(dictionary: Uint8Array?): Array<Number> = TODO()
